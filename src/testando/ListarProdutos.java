...
public class ListarProdutos extends javax.swing.JFrame {
     ...
     */
    public ListarProdutos(Registry reg) throws RemoteException, NotBoundException {
        initComponents();
        registry = reg;
        stub = (Interface) registry.lookup("Hello");
        data = stub.ListarProdutos();
        preencheCampo();
    }

    private void preencheCampo() {
        //Função para listagem e organização das informações
        this.columnNames[0] = "IdTurma";
        this.columnNames[1] = "Escola";
        this.columnNames[2] = "Nome";
        this.columnNames[3] = "Capacidade";
        this.columnNames[4] = "Editar";
        this.columnNames[5] = "Remover";
        ...
        tbRegistros.getColumnModel().getColumn(4).setCellRenderer(new ListarProdutos.ButtonRenderer("Editar")); //criação de botão editar
        tbRegistros.getColumnModel().getColumn(5).setCellRenderer(new ListarProdutos.ButtonRenderer("Remover")); //criação de botão remover
    ...
    private void buttonClicked(java.awt.event.MouseEvent evt) throws RemoteException, NotBoundException, NotBoundException {
        ...
        if (colunaClicada == 4) { //Edita umregistro, chamando uma nova interface
            EditarProdutos e = new EditarProdutos(registry, idEmQuestao);
            this.setVisible(false);
            e.setVisible(true);

        } else if (colunaClicada == 5) {
            // Exclui um registro
            if (stub.ExcluirProdutos(idEmQuestao)) {
            ...
            this.setVisible(false);
            ListarProdutos l = new ListarProdutos(registry);
            l.setVisible(true);
        }
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(spListagem, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.dispose();
        ListarCategorias l = null;
        try {
            l = new ListarCategorias(registry);
        } catch (RemoteException ex) {
            Logger.getLogger(ListarProdutos.class.getName()).log(Level.SEVERE, null, ex);
        } catch (NotBoundException ex) {
            Logger.getLogger(ListarProdutos.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.setVisible(false);
        InserirProdutos i = null;
        try {
            i = new InserirProdutos(registry);
        } catch (RemoteException ex) {
            Logger.getLogger(ListarProdutos.class.getName()).log(Level.SEVERE, null, ex);
        } catch (NotBoundException ex) {
            Logger.getLogger(ListarProdutos.class.getName()).log(Level.SEVERE, null, ex);
